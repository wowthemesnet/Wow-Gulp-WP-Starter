...
gulp.task( 'translate', () => {
    ...
    .pipe( gulp.dest( project.languagefolder + '/' + project.name + '.pot' ) );
});
...
gulp.task( 'dist', ['clean-dist'], function() {
  return gulp.src( ['**/*', '!' + paths.bower, '!' + paths.bower + '/**', '!' + paths.node, '!' + paths.node + '/**', '!' + paths.dev, '!' + paths.dev + '/**', '!' + paths.dist, '!' + paths.dist + '/**', '!' + paths.distprod, '!' + paths.distprod + '/**', '!' + paths.sass, '!' + paths.sass + '/**', '!readme.md', '!package.json', '!package-lock.json', '!gulpfile.js', '!gulpconfig.json', '!CHANGELOG.md', '!.travis.yml', '!jshintignore',  '!codesniffer.ruleset.xml',  '*'], { 'buffer': true } )
  ...
  .pipe( gulp.dest( paths.dist + '/' + project.name ) )
});
...
gulp.task( 'zip', function() {
  return gulp.src(paths.dist + '/' + project.name + '/**')
...
// Run
// gulp deploy
// Generate a theme folder 
gulp.task('deploy', gulpSequence('scripts', 'cleancss', 'sass', 'minifycss', 'translate', 'dist', 'zip'))
